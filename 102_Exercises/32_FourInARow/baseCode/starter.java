 	...
 	public static int checkVertical(String[][] board){
		...
		for(int r = 0; r < board.length - 1; r ++){
			for(int c = 0; c < board[0].length - 1; c ++){
				...
				if(board[r][c].equals(board[r + 1][c]) && board[r][c].equals("A")){
					
					Acounter ++;
					
				}
				
				if(board[r][c].equals(board[r + 1][c]) && board[r][c].equals("B")){
	...
	public static int checkHorizontal(String[][] board){
		...
		for(int r = 0; r < board.length - 1; r ++){
			for(int c = 0; c < board[0].length - 1; c ++){
				...
				if(board[r][c].equals(board[r][c + 1]) && board[r][c].equals("A")){
					
					Acounter ++;
					
				}
				
				if(board[r][c].equals(board[r][c + 1]) && board[r][c].equals("B")){
	...
	public static int checkDiagonal(String[][] board){
		...
		for(int r = 0; r < board.length - 1; r ++){
			...
			for(int c = 0; c < board[0].length - 1; c ++){
				...
				if(board[r][c].equals(board[r + 1][c + 1]) && board[r][c].equals("A")){
					
					Acounter ++;
					
				}
				
				if(board[r][c].equals(board[r + 1][c + 1]) && board[r][c].equals("B")){
