...
class starter {
	...
	public static void main(String args[]) throws InterruptedException {
		...
		if(ans == 1){
			...
			int time = (int)endTimer();
			int errors = compareSentences(sentence , player);
			int LPMOG = (lettersInSentence(sentence));
			int LPM = (((lettersInSentence(player))/time)*100)/60;
			int WPM = (((wordsInSentence(player))/time)*100)/60;
			System.out.println();
			System.out.println("Nice job! Here is your result!");
			System.out.println("Time: " + time + " seconds");
			System.out.println("Errors: " + errors + "/" + LPMOG + " letters");
		...
		if(ans==2){
			...
			sc.nextLine();
			String sentence = getSentence(choose);
			System.out.println("-----------------Your sentence is:-----------------");
			System.out.println(sentence);
			System.out.println("---------------------------------------------------");
			System.out.println();
